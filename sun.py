...
def get_sunrise_sunset( in_day, in_month, in_year, lat_d, lon_d, 
                    is_rise, dst_offset, zenith_d):
  # lon_d:
...
def demo1():
  ...
  print("Local Sunriset at", get_sunrise_sunset(d, m, y, lat_d, lon_d, is_rise, dst_offset, zenith))
...
def demo2():
  ...
  print("Local SunSet at", get_sunrise_sunset(d, m, y, lat_d, lon_d, is_rise, dst_offset, zenith))
...
def demo3():
  ...
  print("\nLocal Sunrise at", get_sunrise_sunset(d, m, y, lat_d, lon_d, True, dst_offset, zenith), "\n")
  print("\nLocal Sunrise at", get_sunrise_sunset(d, m, y, lat_d, lon_d, False, dst_offset, zenith), "\n")
