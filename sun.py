...
def get_sunrise_sunset(in_year, in_month, in_day, is_rise=True,
    ...
    if is_rise:
        ...
        print("approx sunrise at", rise_or_set_time,
              "days since 01-Jan 00:00 (UTC)")
    else:
        rise_or_set_time = doy + ((18 - lon_h) / 24.0)
        print("approx sunset at", rise_or_set_time,
              "days since 01-Jan 00:00 (UTC)")
...
def demo1():
    ...
    print("Local Sunrise at", get_sunrise_sunset(
        y, m, d, is_rise, lat_d, lon_d, tz_offset, zenith))
...
def demo3():
    ...
    print("Local Sunrise at", get_sunrise_sunset(
        y, m, d, True, lat_d, lon_d, tz_offset, zenith))
    print("Should be        07:53\n")
    print("Local Sunset at ", get_sunrise_sunset(
        y, m, d, False, lat_d, lon_d, tz_offset, zenith))
